...
export const ModalTicket = ({ isOpen, onClose, ticketInfo }: ModalTicketProps): JSX.Element | null => {
          ...
          <div className="absolute w-[357px] h-[617px] top-5 left-5">
            <div className="inline-flex flex-col items-start justify-center absolute top-0 left-0">
              ...
              <Textfit
                ...
                className="relative w-full mt-[-1px] font-bold text-white tracking-[0] leading-[normal] overflow-hidden text-ellipsis whitespace-nowrap text-left"
