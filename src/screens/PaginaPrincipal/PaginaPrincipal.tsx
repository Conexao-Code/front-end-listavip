      ...
      <section className="py-20 bg-gradient-to-b from-gray-900 to-gray-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <Trophy className="w-6 h-6 text-[#E1FF01]" />
              <span className="text-[#E1FF01] font-medium">Histórias de Sucesso</span>
            </motion.div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Cases de <span className="text-[#E1FF01]">Sucesso</span>
            </h2>
            <p className="text-gray-400 text-xl max-w-2xl mx-auto">
              Conheça alguns dos eventos que transformamos com nossa tecnologia
            </p>
          </motion.div>
                ...
                <div className="relative h-[400px] rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 z-20 p-8 flex flex-col justify-end">
                    ...
                    <motion.div
                      ...
                      className="mb-4"
                    >
                      <span className="bg-[#E1FF01]/10 text-[#E1FF01] py-2 px-4 rounded-lg inline-block
                                   backdrop-blur-sm border border-[#E1FF01]/20">
                        {item.stats}
                      </span>
                    </motion.div>
                      ...
                      <div className="pt-4 border-t border-gray-700/30">
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2">
                            <Users className="w-4 h-4 text-[#E1FF01]" />
                            <span className="text-sm text-gray-400">+50k participantes</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Calendar className="w-4 h-4 text-[#E1FF01]" />
                            <span className="text-sm text-gray-400">3 dias de evento</span>
                          </div>
                        </div>
                      </div>
                    </motion.div>

                    {/* Botão "Saiba mais" que aparece no hover */}
                    <motion.button
                      initial={{ opacity: 0, y: 20 }}
                      whileHover={{
                        scale: 1.05,
                      ...
                      className="mt-6 w-full py-3 bg-[#E1FF01] text-gray-900 rounded-lg font-semibold
          ...
          >
            {[
              { icon: Users, value: "1M+", label: "Participantes" },
              { icon: Ticket, value: "500k+", label: "Ingressos Vendidos" },
              { icon: DollarSign, value: "10M+", label: "Em Vendas" },
              ...
              <motion.div
                ...
                className="p-6 bg-gray-800/30 rounded-xl border border-gray-700/50 backdrop-blur-sm
                         hover:border-[#E1FF01]/30 group"
              >
                <stat.icon className="w-8 h-8 text-[#E1FF01] mb-4 group-hover:scale-110 transition-transform" />
