...
import { InputField } from "../../components/InputField"; // ajuste o caminho conforme sua estrutura
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Configure todos os detalhes do seu novo evento
              </p>
            </div>
          </div>
        </div>
