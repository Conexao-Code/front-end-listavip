...
import { Zap, BarChart, Users, Shield, Settings, ArrowRight, Check } from 'lucide-react';
...
export const Sobrenos = (): JSX.Element => {
  ...
  const stats = [
    { id: 1, title: "Eventos gerenciados", value: 400, suffix: "+", description: "Eventos de sucesso em todo Brasil" },
    { id: 2, title: "Ingressos vendidos", value: 10000, suffix: "k+", description: "Pessoas impactadas positivamente" },
    { id: 3, title: "Retorno sobre investimento", value: 140, suffix: "%", description: "Média de ROI dos nossos clientes" },
    { id: 4, title: "Avaliações 5 estrelas", value: 200, suffix: "+", description: "Clientes satisfeitos e fidelizados" },
  ];
  ...
  const features = [
    {
      ...
      icon: BarChart,
      description: "Controle completo do seu evento em tempo real com análises preditivas e insights acionáveis para tomada de decisões estratégicas.",
      benefits: [
    ...
    },
    {
      ...
      icon: Users,
      description: "Integração perfeita com as principais plataformas de vendas e redes sociais para maximizar seu alcance e conversão.",
      benefits: [
    ...
    },
    {
      ...
      icon: Shield,
      description: "Sistema robusto de proteção contra fraudes e certificação PCI DSS para garantir transações seguras e confiáveis.",
      benefits: [
    ...
    },
    {
      ...
      icon: Settings,
      description: "Adapte o sistema às suas necessidades específicas com módulos customizáveis e fluxos de trabalho flexíveis.",
      benefits: [
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="text-[#E1FF01] font-medium">Inovação em Eventos</span>
            </motion.div>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-white bg-gradient-to-r from-white via-white to-gray-400">
              Revolucionando a Gestão de <span className="text-[#E1FF01]">Eventos</span>
            </h1>
            <p className="text-gray-400 text-xl max-w-3xl mx-auto leading-relaxed mb-10">
              Transformamos a maneira como eventos são gerenciados com tecnologia inteligente e
              insights baseados em dados para resultados excepcionais
            </p>
            ...
            {features.map((feature, index) => (
              ...
              >
                <motion.div
                  ...
                  className="p-8 bg-gray-800 rounded-xl border border-gray-700/50 shadow-lg shadow-black/20 transition-all duration-300 cursor-pointer group-hover:border-[#E1FF01]/30"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="relative text-4xl md:text-5xl font-bold mb-6">
              Pronto para Revolucionar Seus <span className="text-[#E1FF01]">Eventos</span>?
            </h2>
            <p className="text-gray-400 text-xl mb-10 max-w-2xl mx-auto">
              Comece agora mesmo e experimente a plataforma que está transformando a gestão de eventos no Brasil
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <motion.button
                whileHover={{ scale: 1.05 }}
